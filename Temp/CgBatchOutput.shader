...
lowp vec4 frag( in v2f i ) {
    mediump vec4 col = (texture( _MainTex, i.texcoord) * i.color);
    return vec4( mix( col.xyz, (col.xyz * _Color.xyz), vec3( col.w)), col.w);
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecediimbopgheokakcnnjpkgidpembpadokmabaaaaaakeacaaaaaeaaaaaa
